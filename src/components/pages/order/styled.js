...
import checkboxSelect from "/src/assets/checkboxSelect.svg";
...
export const StyledOrder = styled(Section)`
  ...
  padding-right: 90px;
  margin-bottom: 0;
  background-color: ${(props) => props.theme.colorBackgroundBuy};
    ...
    ${(props) =>
      props.$isChecked
        ? css`
          ...
          `
        : css`
            background-color: ${props.theme.colorBackgroundBuy};
            border: 1px solid rgba(0, 0, 0, 0.1);
          `}
  }
`;
